...
vzorec_podrobnosti = re.compile(
    ...
    r'Plačilo:.*?<td class="tdDataMain">\s{1,100}(?P<neto>.*?)\sNETO,\s'
    r'(?P<bruto>.*?)\sBRUTO.*?'
...
#orodja.zapisi_csv(
#    oglasi,
#    ['delo', 'kraj', 'Regija', 'neto', 'bruto', 'naslov', 'datum_pričetka', 'delovnik', 'število_članov', 'trajanje', 'šifra', 'opis', 'podjetje'],
